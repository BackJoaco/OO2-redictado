# Ejercicio 7: Decodificador de películas 
...
1. novedad: las películas más recientes. 
2. similitud: las películas similares a alguna película que reprodujo, ordenadas de más a menos reciente.
3. puntaje: las películas de mayor puntaje, para igual puntaje considera las más recientes.
...
3. Escriba un test case que incluya estos pasos, con los ejemplos mencionados anteriormente:
    - Configure al decodificador para que sugiera por similitud.
    - Solicite al mismo decodificador las sugerencias.
    - Configure al mismo decodificador para que sugiera por puntaje.
    - Solicite al mismo decodificador las sugerencias.
